...
<div class="absolute bottom-0 left-0 w-full flex justify-center pointer-events-none z-50">
    <div class="w-full max-w-md pointer-events-auto">
        <div class="bg-white px-6 py-3 flex items-center justify-between relative shadow-[0_-4px_24px_rgba(0,0,0,0.03)] border-t border-gray-50">
            <a href="{{ route('dashboard') }}" class="flex flex-col items-center gap-1.5 {{ request()->routeIs('dashboard') ? 'text-[#8b5cf6]' : 'text-gray-400 hover:text-gray-600' }} w-14">
            ...
            <a href="{{ route('savings.index') }}" class="flex flex-col items-center gap-1.5 {{ request()->routeIs('savings.*') ? 'text-[#8b5cf6]' : 'text-gray-400 hover:text-gray-600' }} w-14">
            ...
            <div class="relative -top-8">
                <a href="{{ route('transactions.create') }}" class="w-[54px] h-[54px] rounded-full bg-[#8b5cf6] fab-shadow flex items-center justify-center text-white hover:bg-violet-600 transition-colors border-4 border-white">
            ...
            <a href="{{ route('transactions.index') }}" class="flex flex-col items-center gap-1.5 {{ request()->routeIs('transactions.index') ? 'text-[#8b5cf6]' : 'text-gray-400 hover:text-gray-600' }} w-14">
